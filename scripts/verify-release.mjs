...
const directories = ["core", "runtime", "vue", "lucide", "hugeicons", "create-sketchicon"];
...
for (const manifest of manifests.filter(({ name }) => ["sketchicon", "@sketchicon/vue", "@sketchicon/lucide", "@sketchicon/hugeicons"].includes(name))) {
