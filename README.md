...
Use Preact's JSX configuration (`jsxImportSource: "preact"`). The adapter supports SVG refs, native events, server rendering, and hydration. See [Preact documentation](packages/preact/README.md).
